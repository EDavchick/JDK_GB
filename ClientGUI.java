...
public class ClientGUI extends JFrame implements ClientView {
    ...
    /**
     * Конструктор класса, методы с настройками ниже
     */
    public ClientGUI() {
        setting();
        createPanel();
...
//        setLocation(serverWindow.getX() - 500, serverWindow.getY());
    ...
    /**
     * Метод изменения видимости верхней панели экрана, на которой виджеты для
     * авторизации (например кнопка логин)
    ...
    private Component createHeaderPanel() {
        ...
        tfLogin = new JTextField("Ivan Ivanov");
    ...
    /**
     * Метод срабатывающий при важных событиях связанных с графическим окном
     * (например окно в фокусе)
